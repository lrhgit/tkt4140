...
html=${name}-reveal
system doconce format html $name --pygments_html_style=native --keep_pygments_html_bg --html_links_in_new_window  --encoding=utf-8 --html_output=$html $opt
...
system doconce format html $name --pygments_html_style=perldoc --keep_pygments_html_bg --html_links_in_new_window  --encoding=utf-8 --html_output=$html $opt
system doconce slides_html $html reveal --html_slide_theme=beige

html=${name}-reveal-white
system doconce format html $name --pygments_html_style=default --keep_pygments_html_bg --html_links_in_new_window  --encoding=utf-8 --html_output=$html $opt
...
html=${name}-solarized
system doconce format html $name --pygments_html_style=perldoc --html_style=solarized3 --html_links_in_new_window  --encoding=utf-8 --html_output=$html $opt
...
html=${name}-1
system doconce format html $name --html_style=bloodish --html_links_in_new_window  --encoding=utf-8 --html_output=$html $opt
...
doconce format html $name --html_style=bootstrap_bluegray --html_links_in_new_window  --encoding=utf-8 --html_output=$html $opt
