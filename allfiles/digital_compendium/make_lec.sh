...
html=${name}-reveal
system doconce format html $name --pygments_html_style=native --keep_pygments_html_bg --html_links_in_new_window  --encoding=utf-8 --html_output=$html --no_abort $opt 
...
system doconce format html $name --pygments_html_style=perldoc --keep_pygments_html_bg --html_links_in_new_window  --encoding=utf-8 --html_output=$html  --no_abort $opt
system doconce slides_html $html reveal --html_slide_theme=beige

html=${name}-reveal-white
system doconce format html $name --pygments_html_style=default --keep_pygments_html_bg --html_links_in_new_window  --encoding=utf-8 --html_output=$html  --no_abort $opt
...
html=${name}-solarized
system doconce format html $name --pygments_html_style=perldoc --html_style=solarized3 --html_links_in_new_window  --encoding=utf-8 --html_output=$html  --no_abort $opt
...
html=${name}-1
system doconce format html $name --html_style=bloodish --html_links_in_new_window  --encoding=utf-8 --html_output=$html  --no_abort $opt
...
doconce format html $name --html_style=bootstrap_bluegray --html_links_in_new_window  --encoding=utf-8 --html_output=$html  --no_abort $opt
...
# system doconce format pdflatex $name --latex_title_layout=beamer --latex_table_format=footnotesize --encoding=utf-8 --latex_admon_title_no_period $opt
...
# system doconce format pdflatex $name --minted_latex_style=trac --latex_admon=paragraph --latex_table_format=footnotesize  --encoding=utf-8 $opt
# system doconce ptex2tex $name envir=minted
