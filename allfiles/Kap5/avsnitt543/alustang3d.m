function alustang3d 
% === Ikke-stasjon�r varmetransport i aluminiumstang ===
% Tester theta-skjema for sprang i startbetingelser.
% Som alustang3, men 3D-plott.
%
...
svart = zeros(64,3);
% colormap(svart);
% title('Crank-Nicolson : \theta = 0.5','FontSize',14)
xlabel('x','FontSize',14);
ylabel('t','FontSize',14);

%axis off
%
% === Lokal funksjon solut l�ser theta-skjemaet ===
%
