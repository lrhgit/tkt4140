...
%
clear
% Tilnærmet omregnet data fra Timoshenko:
% "Theory of Plates and Shells".
% Bruker betong istedenfor stål
% SI-version : Lengder i m, krefter i N.

R = 9; % Tankradius
H = 8; % Høyde
t1 = 0.09; % veggtykkelse øverst
t0 = 0.36; % veggtykkelse nederst
ny = 0.20;  % Poissons tall
ga = 9810; % Egenvekt av  vann [N/m^3]
E = 2.5e10; % E-modul [N/m^2]
a = (t0 - t1)/t0;
