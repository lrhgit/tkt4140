...
def tripiv(a, b, c, d):
    """Solution of a linear system of algebraic equations with a
        tri-diagonal matrix of coefficients using the Thomas-algorithm using pivoting.
...
if __name__ == '__main__':
    ...
    def test_tdma():
        """Unit test of tdma equation of 3x3 system with known solution of x1 = 1, x2 = 2, x3 = 3
    ...
    print "x-xanalytic ",x-xanalytic
    print "x2-xanalytic ",x2-xanalytic
