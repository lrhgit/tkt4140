...
if __name__ == '__main__':
    ...
    def test_Stability():
        ...
        LNWDT=0.8; FNT=11
        plt.rcParams['lines.linewidth'] = LNWDT; plt.rcParams['font.size'] = FNT
        f2, axarr = plt.subplots(len(NumericaldiffusionList), len(schemesNames), sharex=True, sharey=True, squeeze=False, figsize=(5, 15))
        lstyle = ['b', 'r', 'g', 'c']
...
#                             jump = 16
        ...
        #plt.tight_layout()
#        plt.savefig('../fig-ch5/couetteFTCS.png' , transparent=True)
#        plt.savefig('../fig-ch5/couetteFTCS.pdf' , transparent=False)
